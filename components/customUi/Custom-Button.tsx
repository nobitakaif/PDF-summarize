      ...
      <button className="button">
        ...
        <div className="state state--default">
          <div className="icon">
                  ...
                  <p>
                      <span style={{ ['--i' as string]: 0 }}>S</span>
                      <span style={{ ['--i' as string]: 1 }}>e</span>
                      <span style={{ ['--i' as string]: 2 }}>n</span>
                      <span style={{ ['--i' as string]: 3 }}>d</span>
                      <span style={{ ['--i' as string]: 4 }}>M</span>
                      <span style={{ ['--i' as string]: 5 }}>e</span>
                      <span style={{ ['--i' as string]: 6 }}>s</span>
                      <span style={{ ['--i' as string]: 7 }}>s</span>
                      <span style={{ ['--i' as string]: 8 }}>a</span>
                      <span style={{ ['--i' as string]: 9 }}>g</span>
                      <span style={{ ['--i' as string]: 10 }}>e</span>
                  </p>
                </div>
                <div className="state state--sent">
                        ...
                        <p>
                            <span style={{ ['--i' as string]: 5 }}>S</span>
                            <span style={{ ['--i' as string]: 6 }}>e</span>
                            <span style={{ ['--i' as string]: 7 }}>n</span>
                            <span style={{ ['--i' as string]: 8 }}>t</span>
                        </p>
                      </div>
